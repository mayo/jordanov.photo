...
document.addEventListener(
  "DOMContentLoaded",
  function () {
    s = new Slideshow(".slideshow .slide");
    ...
    se.bindElement(".slideshow .controls .previous", doAction(se.ACTION_PREV));
    se.bindElement(".slideshow .controls .next", doAction(se.ACTION_NEXT));

    se.bindEvent(se.EVENT_HASHCHANGE, doAction(se.ACTION_HASHCHANGE));

    se.bindTouch(".slideshow");
    ...
    document
      .querySelector('.scrolldown a[href*="#"]:not([href="#"])')
